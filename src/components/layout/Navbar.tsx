...
// เมนูย่อยด้านล่างตามภาพ Reference
const subNavItems = [
...
export function Navbar() {
  ...
  // ติดตามว่าผู้ใช้ scroll ลงมาแล้วหรือยัง
  ...
  return (
    ...
    >
      ...
      {/* Drawer Body (สไลด์มาจากทางขวา) */}
      <div
        className={`fixed inset-y-0 right-0 z-50 my-[16px] mr-[16px] w-[calc(100%-32px)] sm:max-w-[380px] bg-black p-8 px-[40px] pt-[80px] rounded-[20px] shadow-2xl transition-transform duration-300 ease-in-out md:hidden ${
          isOpen ? "translate-x-0" : "translate-x-[calc(100%+16px)]"
        }`}
      >
        {/* Close Button (ปุ่มกากบาท X สีส้มมุมขวาบน) */}
        <button
          type="button"
